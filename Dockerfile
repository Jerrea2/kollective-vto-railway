...
CMD ["/bin/bash","-lc","python /app/startup.py && uvicorn src.Kollective-vto2.inference:app --host 0.0.0.0 --port 80 --log-level debug --proxy-headers --forwarded-allow-ips=\"*\" --workers 1"]
